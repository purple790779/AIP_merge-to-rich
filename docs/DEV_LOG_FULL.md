...
> **문서 목적**: 이 문서는 '머지 머니 타이쿤'의 시작부터 `v1.4.0`까지의 모든 개발 과정을 기록한 종합 보고서입니다. NotebookLM 등의 AI 도구가 분석하여 마인드맵, 인포그래픽, 데이터 표 등을 생성할 수 있도록 체계적으로 구조화되었습니다.
...
| **현재 버전** | `v1.4.0` (Updated: 2026-03-05) |
